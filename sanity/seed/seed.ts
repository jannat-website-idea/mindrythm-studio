...
const testimonials = [
  {
    _id: "testimonial-google-profile",
    _type: "testimonial",
    sortOrder: 10,
    title: "From Mindrythm Studios",
    quote: "Mindrythm Weddings is a cinematic wedding photography and filmmaking studio specializing in editorial, emotional, and timeless wedding storytelling. We create luxury wedding visuals that capture genuine moments with an artistic and cinematic approach.",
    clientType: "Google Business Profile",
    rating: 5,
    reviewUrl: "https://www.google.com/search?kgmid=/g/11njpxjhwk&q=Mindrythm+Studios",
    theme: "light",
  },
  {
    _id: "testimonial-event-partner",
    _type: "testimonial",
    sortOrder: 20,
    title: "Beautiful coverage, handled with total clarity.",
    quote: "From the run sheet to the final delivery, the process was calm, considered and focused on the moments that mattered to our guests and brand.",
    clientType: "Event partner",
    rating: 5,
    reviewUrl: "https://www.google.com/search?kgmid=/g/11njpxjhwk&q=Mindrythm+Studios",
    theme: "dark",
  },
