...
export const defaultItems: ContentItem[] = withItemDefaults([
  ...
  // Additional curated Spaces gallery items to fill the bento board
  {
    id: "gallery-green-object",
    kind: "gallery",
    sortOrder: 80,
    title: "Object Study",
    eyebrow: "Spaces",
    body: "A single green form against warm texture, an exercise in restraint and material.",
    mediaUrl: "/images/green-object.jpg",
    mediaAlt: "Minimal green object on warm textured surface",
    category: "Spaces",
    mediaType: "image",
    layoutType: "medium",
    year: "2026",
  ...
  {
    id: "gallery-dance-study",
    kind: "gallery",
    sortOrder: 90,
    title: "Movement Study",
    eyebrow: "Spaces",
    body: "A dancer framed by clean architecture, where body and space share the same rhythm.",
    mediaUrl: "/images/dance-study.jpg",
    mediaAlt: "Dancer in motion against minimal architectural background",
    category: "Spaces",
    mediaType: "image",
    layoutType: "large",
    year: "2026",
  ...
  {
    id: "gallery-tropical-interior",
    kind: "gallery",
    sortOrder: 100,
    title: "Tropical Welcome",
    eyebrow: "Spaces",
    body: "Natural reception details and handcrafted furniture in a wellness destination.",
    mediaUrl: "/images/tropical-interior.jpg",
    mediaAlt: "Tropical retreat reception interior",
    category: "Spaces",
    mediaType: "image",
    layoutType: "medium",
    year: "2026",
  ...
  {
    id: "gallery-villa-pool",
    kind: "gallery",
    sortOrder: 110,
    title: "Room to Breathe",
    eyebrow: "Spaces",
    body: "An open-air pavilion beneath a thatched roof, connected to forest and light.",
    mediaUrl: "/images/villa-pool.jpg",
    mediaAlt: "Open-air yoga pavilion by a tropical pool",
    category: "Spaces",
    mediaType: "image",
    layoutType: "large",
    year: "2026",
