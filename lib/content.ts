...
export const defaultItems: ContentItem[] = [
  ...
  // Default Curated Gallery Items: Spaces
  {
    id: "gallery-minimal-elegance",
    kind: "gallery",
    sortOrder: 10,
    title: "Minimal Elegance",
    eyebrow: "Retreat Suite",
  ...
  {
    id: "gallery-soft-details",
    kind: "gallery",
    sortOrder: 20,
    title: "Soft Details",
    eyebrow: "Living Quarters",
  ...
  },
  {
    ...
    eyebrow: "Artistic Facade",
    body: "Exterior earth-tone facade painted with botanical murals and tree textures.",
    mediaUrl: "/images/modern-house.jpg",
    mediaAlt: "Hand painted wall murals on retreat cottage",
    category: "Spaces",
    year: "2026",
    href: "",
    accent: "rust",
  },
  {
    ...
    eyebrow: "Retreat Forest",
    body: "Two wellness guests walking through the verdant forest canopy towards the quiet sanctuary.",
    mediaUrl: "/images/villa-pool.jpg",
    mediaAlt: "Forest pathway in lush tropical greenery",
    category: "Spaces",
    year: "2026",
    href: "",
    accent: "sage",
  },
  {
    ...
    eyebrow: "Sanctuary Lounge",
    body: "Naturally illuminated retreat room with handwoven basketry, white walls, and wooden bed frame.",
    mediaUrl: "/images/resort-exterior.jpg",
    mediaAlt: "Naturally lit room with wooden furnishings",
    category: "Spaces",
    year: "2026",
    href: "",
    accent: "ink",
  },
  {
    ...
    eyebrow: "Ambient Corner",
    body: "Dark ambient bedroom corner with potted plant and soft evening shadow.",
    mediaUrl: "/images/green-object.jpg",
    mediaAlt: "Clean bedroom corner with single plant vase",
    category: "Spaces",
    year: "2026",
    href: "",
    accent: "rust",
