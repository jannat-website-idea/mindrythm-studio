  ...
  return (
    <main className="legal-page">
      ...
      <section>
        ...
        <p>This website presents the work, services and creative perspective of Mind Rythm Studio. Project information is provided for general reference and may change.</p>
        <h2>Creative ownership</h2>
        <p>Unless stated otherwise, visual work, text and brand materials on this website belong to Mind Rythm Studio or the credited collaborators and may not be reused without permission.</p>
